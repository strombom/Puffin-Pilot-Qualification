...
#ifndef IMU_ORIENTATION_FILTER_MADGWICK_H
#define IMU_ORIENTATION_FILTER_MADGWICK_H
...
class ImuOrientationFilterMadgwick
{
  public:

    ImuOrientationFilterMadgwick();
    virtual ~ImuOrientationFilterMadgwick();
