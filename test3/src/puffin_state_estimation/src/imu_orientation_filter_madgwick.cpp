...
ImuOrientationFilterMadgwick::ImuOrientationFilterMadgwick() :
...
void ImuOrientationFilterMadgwick::madgwickAHRSupdate(
    float gx, float gy, float gz,
...
void ImuOrientationFilterMadgwick::madgwickAHRSupdateIMU(
    float gx, float gy, float gz,
    float ax, float ay, float az,
    float dt)
{
