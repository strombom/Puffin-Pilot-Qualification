...
Experiment1.Pos = readTF(bag1, topic_pos);
Experiment2.Pos = readTF(bag2, topic_pos);
...
Experiment1.Pos.q = [Experiment1.Pos.q(4,:); Experiment1.Pos.q(1,:);Experiment1.Pos.q(2,:); Experiment1.Pos.q(3,:)];
Experiment1.IMU.q = [Experiment1.IMU.q(4,:); Experiment1.IMU.q(1,:);Experiment1.IMU.q(2,:); Experiment1.IMU.q(3,:)];
Experiment2.Pos.q = [Experiment2.Pos.q(4,:); Experiment2.Pos.q(1,:);Experiment2.Pos.q(2,:); Experiment2.Pos.q(3,:)];
Experiment2.IMU.q = [Experiment2.IMU.q(4,:); Experiment2.IMU.q(1,:);Experiment2.IMU.q(2,:); Experiment2.IMU.q(3,:)];


Experiment1.rpy     = quat2rpy(Experiment1.Pos.q);
Experiment1.rpy_imu = quat2rpy(Experiment1.IMU.q);

Experiment2.rpy     = quat2rpy(Experiment2.Pos.q);
...
k_pitch_roll = 1; %(51.2*pi/180)/2047;
k_thrust = 1; %100/4095;

Experiment1.roll_cmd    = (Experiment1.RCData.channel(2,:)-2047)*k_pitch_roll;
Experiment1.pitch_cmd   = (Experiment1.RCData.channel(1,:)-2047)*k_pitch_roll;
Experiment1.thrust_cmd  = Experiment1.RCData.channel(3,:)*k_thrust;

Experiment2.roll_cmd    = (Experiment2.RCData.channel(2,:)-2047)*k_pitch_roll;
Experiment2.pitch_cmd   = (Experiment2.RCData.channel(1,:)-2047)*k_pitch_roll;
