...
bagfile_exp1 =  '/home/jst/development/puffin-pilot/test3/system_identification/c1.bag';
bagfile_exp2 =  '/home/jst/development/puffin-pilot/test3/system_identification/c2.bag';

topic_pose = '/rtc_pose';
topic_ctrl = '/uav/input/rateThrust';
topic_joy = '/puffin_pilot/roll_pitch_yawrate_thrust'; % Ar egentligen rollpitchyawthrust
...
Experiment1.Pose = readTwistStamped(bag1, topic_pose);
Experiment2.Pose = readTwistStamped(bag2, topic_pose);
Experiment1.Ctrl = readCommandRateThrust(bag1, topic_ctrl);
Experiment2.Ctrl = readCommandRateThrust(bag2, topic_ctrl);
Experiment1.Joy = readCommandRateThrust(bag1, topic_joy); % Ar egentligen rollpitchyawthrust
Experiment2.Joy = readCommandRateThrust(bag2, topic_joy); % Ar egentligen rollpitchyawthrust
